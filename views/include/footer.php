    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-6 col-lg-2 mb-3">
                <h5>Projects</h5>
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="https://github.com/">Ozone Admin Panel</a></li>
                    <li class="mb-2"><a href="https://github.com/">Ozone Web App</a></li>
                    <li class="mb-2"><a href="https://github.com/">Responsive Media Query </a></li>
                </ul>
            </div>
            <div class="col-6 col-lg-2 mb-3">
                <h5>Community</h5>
